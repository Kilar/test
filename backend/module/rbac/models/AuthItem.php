...
class AuthItem extends BaseActiveRecord
{
    ...
    public static function getRoleNameByUid(int $userId, bool $cached=true)
    {
        ...
        $cachekey = Yii::$app->params['cache_prefix']['rbac']['a'].'_'.$userId;
        if($userId<1){
            return [];
    ...
    public static function getDesByUid(int $userId, bool $cached=true)
    {
        ...
        $cachekey = Yii::$app->params['cache_prefix']['rbac']['b'].'_'.$userId;
        if ($userId<1) {
            return $return;
    ...
    {
        $nameKey = Yii::$app->params['cache_prefix']['rbac']['a'].'_'.$userId;
        $desKey = Yii::$app->params['cache_prefix']['rbac']['b'].'_'.$userId;
        $cache = \Yii::$app->getCache();
