...
//         //->setFrom(['a984844048@qq.com' => 'Yii 中文网'])
//         ->setTo('3055815121@qq.com')
//         ->setSubject('邮件发送配置')
//         //->setTextBody('Yii中文网教程真好 www.yii-china.com')   //发布纯文字文本
//         ->setHtmlBody("<br>Yii中文网教程真好！www.yii-china.com1111")    //发布可以带html标签的文本
//         ->send();
//         if($mail)
//             echo 'success';
//         else
...
//         Common::p(\Yii::$app->getRequest()->getMethod());
//         SysHelper::$ckDomain = '.yii.ee';
//         SysHelper::setCookie('hhh', 'bbb');
